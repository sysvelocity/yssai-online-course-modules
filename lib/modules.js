...
import { module6_2_3Prompt } from "./prompts/module6.2.3.js";
...
import { module6_5_2Prompt } from "./prompts/module6.5.2.js";
import { module6_5_3Prompt } from "./prompts/module6.5.3.js";
import { supportChatPrompt } from "./prompts/support.js";
import { supportChatKnowledge } from "./knowledge/support.js";

const VOICE_DICTATION_DEFAULT_ENABLED = true;
...
const MODULES = {
  ...
  "module-3": {
    ...
    knowledgeText: [
      "# Module 1 Story Philosophy Lens",
      module1Knowledge,
      "# Module 2 Common Sales Story Sins Lens",
      module2Knowledge,
      "# Module 4 Diagnostic Lens",
      module4Knowledge,
      "# Module 5 Diagnostic Lens",
      module5Knowledge
    ].join("\n\n"),
    vectorStoreEnvVar: "",
    scopeClassifierPrompt: buildScopeClassifierPrompt(
  ...
  "6.2.3": {
    slug: "6.2.3",
    moduleNumber: "Module 6.2.3",
    shortLabel: "6.2.3",
    title: "Email to Target Prospect (#3)",
    subtitle:
      "Sales friend, now it's time to put all your effort on building your sales story to work. This short prospecting email uses your bridge line, client issues addressed, and one trust-building differentiator, offer, or proof point, with the opening context inferred from your sales story when needed.",
    emptyTitle: "Build Your Short Contextual Prospecting Email",
    emptyCopy:
      "Share the first name of the person you're emailing, your bridge line, client issues addressed, differentiators, optional offer or proof point, and your CTA. If you already have a contextual opener, include it, otherwise this module will infer one from your sales story.",
    inputPlaceholder:
      "Paste the first name of the person you're emailing, your bridge line, issues, differentiators, optional offer or proof point, and CTA, or ask how to get started.",
    prompt: module6_2_3Prompt,
    vectorStoreEnvVar: "",
    scopeClassifierPrompt: buildScopeClassifierPrompt(
      "build, refine, continue, or restart the Email to Target Prospect (#3) from the user's bridge line, client issues addressed, differentiators, optional offer or proof point, CTA, and directly related source material"
    ),
    scopeErrorMessage:
      "This AI Assist is only for building a short target prospect email from your sales story inputs and directly related source material."
  },
  "6.3.1": {
    slug: "6.3.1",
  ...
  "6.5.2": {
    slug: "6.5.2",
    moduleNumber: "Module 6.5.2",
    shortLabel: "6.5.2",
    title: "Discovery Questions From Customer Issues",
    subtitle:
      "Sales friend, let's turn your sales story into practical discovery questions you can use on a live call. This module builds natural questions from your bridge line, customer issues addressed, and optional differentiators or offer.",
    emptyTitle: "Build Your Discovery Questions",
    emptyCopy:
      "Paste your bridge line and customer issues addressed, plus any optional differentiators, offer, or existing questions. This module will turn them into practical discovery questions that help surface the real issue in conversation.",
    inputPlaceholder:
      "Paste your bridge line, customer issues addressed, and any optional differentiators, offer, or existing questions.",
    prompt: module6_5_2Prompt,
    knowledgeText: [
      "# Module 4 Customer Issues Addressed Lens",
      module4Knowledge,
      "# Module 5 Differentiation Lens",
      module5Knowledge
    ].join("\n\n"),
    vectorStoreEnvVars: [],
    scopeClassifierPrompt:
      "You decide whether a user input reasonably aligns with the purpose of this module. " +
      "The purpose of this module is to build, refine, continue, or restart discovery questions from the user's bridge line, customer issues addressed, optional differentiators, optional offer, existing questions, attachments, and directly related source material. " +
      "Be strongly biased toward ALLOW. " +
      "Allow raw pasted bridge lines, customer issues addressed, differentiators, offers, discovery questions, call notes, headings, numbered lists, messy notes, attachment-related requests, and structured source material even when the user does not write an explicit request sentence. " +
      "If the pasted content looks like module working material that could reasonably be turned into discovery questions, respond ALLOW. " +
      "Only respond BLOCK if the input clearly does not make sense for this module and is clearly trying to use the app for a different task entirely. " +
      "Respond with one word only: ALLOW or BLOCK.",
    scopeErrorMessage:
      "This AI Assist is only for building discovery questions from your bridge line, customer issues addressed, differentiators, offers, existing questions, and directly related source material."
  },
  "6.5.3": {
    slug: "6.5.3",
    moduleNumber: "Module 6.5.3",
    shortLabel: "6.5.3",
    title: "Proposal Executive Summary",
    subtitle:
      "Sales friend, let's turn your sales story into a customer-led executive summary for a proposal. This module uses the proposal recipient, optional background, bridge line, customer issues addressed, differentiators, and optional offer to create a few concise proposal-ready paragraphs.",
    emptyTitle: "Build Your Proposal Executive Summary",
    emptyCopy:
      "Paste the proposal recipient's name, any proposal background, your bridge line, customer issues addressed, differentiators, and any optional offer or proof points. This module will turn them into an executive summary page for a proposal.",
    inputPlaceholder:
      "Paste the recipient name, background, bridge line, customer issues addressed, differentiators, and any optional offer or proof points.",
    prompt: module6_5_3Prompt,
    knowledgeText: [
      "# Module 4 Customer Issues Addressed Lens",
      module4Knowledge,
      "# Module 5 Differentiation Lens",
    ...
    scopeClassifierPrompt:
      "You decide whether a user input reasonably aligns with the purpose of this module. " +
      "The purpose of this module is to build, refine, continue, or restart a proposal executive summary from the user's proposal recipient name, optional background, bridge line, customer issues addressed, differentiators, optional offer, optional proof points, attachments, and directly related source material. " +
      "Be strongly biased toward ALLOW. " +
      "Allow raw pasted proposal notes, bridge lines, customer issues addressed, differentiators, offers, proof points, recipient names, proposal background, headings, numbered lists, messy notes, attachment-related requests, and structured source material even when the user does not write an explicit request sentence. " +
      "If the pasted content looks like module working material that could reasonably be turned into a proposal executive summary, respond ALLOW. " +
      "Only respond BLOCK if the input clearly does not make sense for this module and is clearly trying to use the app for a different task entirely. " +
      "Respond with one word only: ALLOW or BLOCK.",
    scopeErrorMessage:
      "This AI Assist is only for building a proposal executive summary from your recipient name, proposal background, bridge line, customer issues addressed, differentiators, optional offer, proof points, and directly related source material."
  },
  "support-chat": {
    slug: "support-chat",
...
export function getPublicModuleConfig(slug) {
  ...
  return {
    ...
    voiceDictationEnabled:
      moduleDef.voiceDictationEnabled === true ||
      (VOICE_DICTATION_DEFAULT_ENABLED && moduleDef.voiceDictationEnabled !== false)
  };
}
