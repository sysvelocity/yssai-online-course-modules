...
const MODULES = {
  ...
  "6.4.2": {
    ...
    subtitle:
      "Sales friend, now let's turn your sales story into a very short social voice note for someone who already knows you. We'll keep it short, natural, and spoken, using one opener, one or two pains, one differentiator or offer, and a simple CTA.",
    emptyTitle: "Build Your Short Social Voice Note",
    emptyCopy:
      "Choose one opener, then share an optional short bridge, two concise client issues or pains, one optional offer, one differentiator, and your CTA. This module will turn that into a short spoken voice-note script.",
    inputPlaceholder:
      "Choose an opener and paste your short voice-note inputs, or ask how to get started.",
