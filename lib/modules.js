...
const MODULES = {
  ...
  "6.1.1": {
    ...
    scopeClassifierPrompt:
      ...
      "Also allow partial step-by-step input collection. If the user provides only some of the requested inputs, that is still in scope and must be ALLOWed. " +
      "If the user is answering a question the assistant just asked, even in shorthand or comma-separated form, that is in scope and must be ALLOWed. " +
      "Only respond BLOCK if the request is clearly unrelated to the module or is an obvious attempt to use the tool for a different task entirely. " +
      "If there is any reasonable chance the request is connected to the current module work, respond ALLOW. Respond with one word only: ALLOW or BLOCK.",
    scopeErrorMessage:
  ...
  "6.2.2": {
    ...
    subtitle:
      "An email to target prospect example will be created from 3 issues addressed + 2 Differentiators. Format 'I lead our <team> and was hoping to spend just a minute...'",
    emptyTitle: "Build Your Target Prospect Email",
    emptyCopy:
    ...
    scopeClassifierPrompt:
      ...
      "Also allow partial step-by-step input collection. If the user provides only some of the requested inputs, for example their full name, team, industry, company name, phone number, bridge line, client issues addressed, offer, or differentiators, that is still in scope and must be ALLOWed. " +
      "If the user is answering a question the assistant just asked, even in shorthand or comma-separated form, that is in scope and must be ALLOWed. " +
      "Only respond BLOCK if the request is clearly unrelated to the module or is an obvious attempt to use the tool for a different task entirely. " +
      "If there is any reasonable chance the request is connected to the current module work, respond ALLOW. Respond with one word only: ALLOW or BLOCK.",
    scopeErrorMessage:
