...
- treat the bridge line as source material to be rewritten into natural proposal prose, not as a raw line to paste into the summary
- never drop in a bridge line fragment as a stand-alone clause or sentence stub, especially if it ends with wording like "when", "who are looking to", "who need", "helping", or other incomplete lead-in language
- if the bridge line is written as an incomplete prompt or worksheet stem, convert it into a complete sentence about the customer's situation, or omit the fragment entirely if it does not read naturally
- do not use ellipses or unfinished lead-in phrases anywhere in the final summary
- every sentence in the final summary must be complete, fully grammatical, and able to stand on its own in a proposal document
